...
# Rutas de modelo y etiquetas (nivel superior a /backend)
...
# Cargar diccionario de comandos
...
# Endpoint para predicción de letra
...
# Endpoint para ejecutar palabra detectada
...
def execute_word():
    ...
    if not ruta:
        return jsonify({"error": f"No hay comando definido para '{word}'"}), 404
